...
export const mapProviderDict = () =>
  dict({
    data: [
      { value: 'amap', label: '高德地图' },
      { value: 'tianditu', label: '天地图' },
      { value: 'mars3d', label: 'Mars3D' },
...
export const resourceTypeDict = () =>
  dict({
    data: [
      { value: '正射影像', label: '正射影像' },
      { value: '倾斜摄影', label: '倾斜摄影' },
      { value: 'DEM高程', label: 'DEM 高程' },
      { value: '矢量数据', label: '矢量数据' },
      { value: '标注数据', label: '标注数据' },
      { value: '点云数据', label: '点云数据' },
    ],
  });

export const resourceStatusDict = () =>
  dict({
    data: [
...
export const layerTypeDict = () =>
  dict({
    data: [
      { value: '底图', label: '底图' },
      { value: '业务图层', label: '业务图层' },
      { value: '叠加图层', label: '叠加图层' },
      { value: '热力图', label: '热力图' },
      { value: '标注图层', label: '标注图层' },
    ],
  });

export const coordinateDict = () =>
  dict({
    data: [
